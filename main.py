...
def attack(char_name: str, char_class: str) -> str:
    """Выводит урон от команды attack."""
...
def defence(char_name: str, char_class: str) -> str:
    """Выводит блокировку урона от команды defence."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Выводит применение специального навыка.
    Указывает урон и блокировку."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Выбирает ввести одну из команд."""
    if char_class == 'warrior':
...
if __name__ == '__main__':
    """Запускает анимированную заставку."""
    run_screensaver()
